...
<div className='overflow-scroll no-scrollbar   py-2 md:py-3  '>
            ...
            <div className='  w-2/5   md:w-2/5 p-2 bg-white rounded-md'>
                <Image src={box1} width={400} height={400} className='rounded-sm' alt={"box1"}/>
               <div className='ps-1'>
            ...
            <div className='  w-2/5  md:w-2/5 p-2 bg-white rounded-md mx-5'>
                <Image src={box2} width={400} height={400} className='rounded-sm' alt={"box1"}/>
               <div className='ps-1'>
            ...
            <div className='  w-2/5  md:w-2/5 p-2 bg-white rounded-md'>
                <Image src={box3} width={400} height={400} className='rounded-sm' alt={"box1"}/>
               <div className='ps-1'>
