...
<nav class=" w-100 max-w-[1440px] mx-auto bg-white border-gray-200 dark:bg-gray-900">
  ...
  <a href="https://iec.com/" class="flex items-center flex-grow   ">
      <Image src={logo}     class="w-64  h-9 ms-1 md:mx-2" alt="Flowbite Logo" />
      
  </a>
  <div class="flex items-center md:order-2">
      <button type="button" class="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
        <span class="sr-only">Open user menu</span>
        <Image class=" rounded-full" src={userPic} alt="user photo" />
      </button>
  ...
  <div class="items-center justify-end hidden text-sm  flex-shrink  md:flex md:items-center   md:order-1 mx-4" id="navbar-user">
    <ul class="flex flex-col text-center    md:items-center   font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-2 lg:space-x-4  md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
      <li>
...
<div className="relative">
 ...
 <li>
      ...
      <li>
        <a href="#" class="z block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">IEC Fellows</a>
      </li>
      <li>
