      ...
      <div className=" bg-slate-200 h-5/6">
        ...
        <div className={`relative h-full  bg-[#12125A] z-10  `}  >
          ...
          <div className={`    relative w-full h-full  py-4   `} >
            ...
            <div className=" hidden md:block absolute top-[90%] left-0 w-full  h-2/6    ">
            <div className=" bg-white   w-5/6 mx-auto h-3/5 shadow-slate-500 shadow-md  rounded-md divide-x-2 divide-red-500  flex justify-between items-center px-5 ">
      <div className=" text-center md:text-xl lg:text-2xl flex-1  flex flex-col items-center justify-center h-3/4 font-bold text-[#12125A]">
        <h4 className="pt-3">230</h4>
        <p className="text-base font-normal">Graduates</p>
        </div>
      
      <div className=" text-center md:text-xl lg:text-2xl flex-1  flex flex-col items-center justify-center  h-3/4 font-bold text-2xl text-[#12125A]">
