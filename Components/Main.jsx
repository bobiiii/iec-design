    ...
    <div className=" bg-slate-600 md:h-screen ">
      <div className=" bg-slate-200 md:h-3/4">
        ...
        <div className={`relative h-full  bg-[#12125A]`}  >
          <Image src={bg1}  className="absolute h-full w-full  opacity-40"/>
          <div className={`    relative w-full h-full    `} >
            ...
            <div className=" bg-white  w-3/4 mx-auto h-1/5 rounded-md divide-x-2 divide-red-500  flex justify-between items-center px-5 ">
      <div className=" text-center flex-1 h-3/4 font-bold text-2xl text-[#12125A]">
